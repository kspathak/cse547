...
Using this, I implement the simple line $f(x) = 2x$ in two ways: (1)
verbosely using the sign function ($f$) and (2) the canonical way
($g$) in Listing \ref{lst:fg_diff}.
...
\item How many parameters do we need to estimate? What are these
  ...
  $w_k$ each which is a $D$-dimensional vector. There are $(R - 1)D$
